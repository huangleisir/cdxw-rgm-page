...
window.bootbox = window.bootbox || function a(b, c) {
	...
	function h(a) {
		...
		g(c, function (a, e, f) {
			...
			e.label || (e.label = a),
			e.className || (e.className = 2 >= d && f === d - 1 ? "btn-primary btn-sm" : "btn-default btn-sm")
		}),
		a
	}
	function i(a, b) {
	...
	r.dialog = function (a) {
		...
		if (g(f, function (a, b) {
				...
				j[a] = b.callback
			}), d.find(".bootbox-body").html("<span style='font-size:20px'>"+a.message+"</span>"), a.animate === !0 && c.addClass("fade"), a.className && c.addClass(a.className), a.title && d.before(o.header), a.closeButton) {
		...
		i.length && (d.after(o.footer), c.find(".modal-footer").html(i)),
